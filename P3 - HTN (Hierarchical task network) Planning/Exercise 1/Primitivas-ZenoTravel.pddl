(:durative-action board     ;     EMBARCAR
...
(:durative-action debark    ; DESEMBARCAR
 :parameters (?p - person ?a - aircraft ?c - city)
...
(:durative-action zoom      ; VOLAR RAPIDO
 :parameters (?a - aircraft ?c1 ?c2 - city)
...
(:durative-action refuel    ; REPOSTAR
